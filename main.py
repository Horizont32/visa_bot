...
# driver = uc.Chrome(driver_executable_path='/Users/artemgolovachev/bin/chromedriver2')
...
time.sleep(3)
location_selector_reg = driver.find_element(By.XPATH, '//div[@role="listbox"]/mat-option[@id="mat-option-6"]').click()
time.sleep(3)
